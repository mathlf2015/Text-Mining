...
class Text_Score():
    ...
    def __init__(self,rawdata_file,score_file,seg_file='C:/Users/Data/Desktop/no_need.csv'):
    ...
    def seg_sentence_sentiment_score(self, source):
        ...
        for keyword in source:
            ...
            for review in source[keyword]:
                ...
                # print(self.transform_to_positive_num(poscount, negcount))
                output[keyword].append(self.transform_to_positive_num(poscount, negcount))      # [[s1_score], [s2_score], ...]
...
# test = Text_Score(r'C:\Users\Data\Desktop\高露洁_ForJack.csv', 'C:/Users/Data/Desktop/score_for_quency.csv')
