...
def fetch_feature(sample_filename,feature_filename,item_brand):
    ...
    csvfile = open(feature_filename, 'w')
...
if __name__=='__main__':
    item_brand=dict()
    fetch_feature('E:/mydata/fresh_comp_offline/test.csv','E:/mydata/fresh_comp_offline/data_feature.csv',item_brand)