...
df_3=df_2.apply(lambda x:np.exp(x))
print(df_3.head())
df_4 = df_3.apply(lambda x:np.rint(x))
df_5=df_4.stack().unstack(0).stack()
#print(df_4)
df_5.apply(lambda x:str(x)).to_csv('E:/mydata/tianchi_wanyiyun/upload_6_2.csv',encoding='utf-8')
