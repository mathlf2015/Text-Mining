...
y_train_pred = forest.predict(diabetes_X_train)
y_test_pred = forest.predict(diabetes_X_test)
print('MSE train: %.3f, test: %.3f' % (mean_squared_error(diabetes_y_train, y_train_pred),mean_squared_error(diabetes_y_test, y_test_pred)))
print('R^2 train: %.3f, test: %.3f' % (r2_score(diabetes_y_train, y_train_pred),r2_score(diabetes_y_test, y_test_pred)))
